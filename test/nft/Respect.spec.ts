...
describe("ER721 Respect Token", function () {
    ...
    describe("Burning", function () {
        ...
        it("Должен произойти сбой в сжигании своих токенов по причине отсутствия токена", async function () {

        });

        it("Должен сжечь свой токен до истечения срока жизни", async function () {

        });

        it("Должен сжечь свой токен после истечения срока жизни", async function () {
